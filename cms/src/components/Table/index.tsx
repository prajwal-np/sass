...
export default function TableComponent({ addNewView }: Props) {
      ...
      case "actions":
        return (
          <div className="relative flex items-center gap-4">
            <Tooltip content="Edit" onClick={() => setCurrentView("addNew")}>
              <EditIcon className="w-6 text-default-400 cursor-pointer active:opacity-50" />
            </Tooltip>
            <Tooltip color="danger" content="Delete user">
              <TrashIcon className="w-6 text-danger cursor-pointer " />
            </Tooltip>
          </div>
        );
      default:
